...
class UI:
    ...
    def refresh_tracker(self):
        ...
        if tracked_agent.chosen_action_success: pair = fg_bright_color_pair
        else: pair = bright_red_color_pair
        self.tracker.addstr(3, 2, "{:<12}".format('AI:'), fg_bright_color_pair)
